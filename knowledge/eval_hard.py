...
_CASES = [
    ...
    ("hi-02", "Saare pending payment wale kaam dikhao",
    ...
    # ── H. poc_email edges (3) ───────────────────────────────────────────────
    ("poc-01", "Show me the jobs with no email on file",
    ...
    ("owe-23", "How much is Content Lab short on paying me?",
     _plan("sum", "fees", {"client_name": "Content Lab", "paid": "no"}),
     ["unpaid", "client", "sum", "idiom"], "en"),
    ("owe-24", "How many Ogilvy jobs still need paying?",
     _plan("count", None, {"client_name": "Ogilvy", "paid": "no"}),
    ...
    ("comp-10", "How much does Maruti owe me this year?",
     ...
     ["compound", "client", "unpaid", "date", "sum"], "en"),
    ("comp-11", "Show me paid Star Studios jobs in Q1",
    ...
    ("poc-04", "List every job where the client email is blank",
     _plan(None, None, {"poc_email": "null"}),
     ["poc_email", "null", "list"], "en"),
